...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(e,t,n){let r=new Float32Array(ao),i=new K(0,1,0);return new Ji({name:`SphericalGaussianBlur`,defines:{n:ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(){return new Ji({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Ji({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Co(),fragmentShader:`
	...
	`}var wo=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ji(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Sl=class extends ul{constructor(){super(),this.isOutputPass=!0,this.uniforms=Gi.clone(xl.uniforms),this.material=new Yi({name:xl.name,uniforms:this.uniforms,vertexShader:xl.vertexShader,fragmentShader:xl.fragmentShader}),this._fsQuad=new pl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Cl=class{constructor(e){if(this.container=e,this.width=e.clientWidth||window.innerWidth,this.height=e.clientHeight||window.innerHeight,!(document.createElement(`canvas`).getContext(`webgl2`)||document.createElement(`canvas`).getContext(`webgl`)))throw e.innerHTML=`<div style="color:#ff9999;text-align:center;margin-top:40vh;font-family:sans-serif;padding:20px;"><h2>WebGL Not Supported</h2><p>Your browser does not support WebGL, which is required for this application.</p><p>Please try a modern browser like Chrome, Firefox, or Edge.</p></div>`,Error(`WebGL not supported`);this.scene=new jn,this.scene.background=new Y(5),this.camera=new ba(60,this.width/this.height,.1,3e3),this.camera.position.set(0,200,500),this.renderer=new cl({antialias:!0,alpha:!1}),this.renderer.setSize(this.width,this.height),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1,e.appendChild(this.renderer.domElement),this.clock=new Va,this.setupPostProcessing(),this.setupLights()}setupPostProcessing(){this.composer=new _l(this.renderer);let e=new vl(this.scene,this.camera);this.composer.addPass(e),this.bloomPass=new bl(new G(this.width,this.height),1.2,.4,.85),this.composer.addPass(this.bloomPass);let t=new Sl;this.composer.addPass(t)}setupLights(){let e=new Sa(1118498,.5);this.scene.add(e)}resize(){this.width=this.container.clientWidth,this.height=this.container.clientHeight,this.camera.aspect=this.width/this.height,this.camera.updateProjectionMatrix(),this.renderer.setSize(this.width,this.height),this.composer.setSize(this.width,this.height)}render(){this.composer.render()}getDelta(){return this.clock.getDelta()}getElapsed(){return this.clock.getElapsedTime()}},wl={type:`change`},Tl={type:`start`},El={type:`end`},Dl=new $r,Ol=new yi,kl=Math.cos(70*Tt.DEG2RAD),Al=new K,jl=2*Math.PI,$={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Ml=1e-6,Nl=class extends Ua{constructor(n,r=null){super(n,r),this.state=$.NONE,this.target=new K,this.cursor=new K,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new K,this._lastQuaternion=new Et,this._lastTargetPosition=new K,this._quat=new Et().setFromUnitVectors(n.up,new K(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Ha,this._sphericalDelta=new Ha,this._scale=1,this._panOffset=new K,this._rotateStart=new G,this._rotateEnd=new G,this._rotateDelta=new G,this._panStart=new G,this._panEnd=new G,this._panDelta=new G,this._dollyStart=new G,this._dollyEnd=new G,this._dollyDelta=new G,this._dollyDirection=new K,this._mouse=new G,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Fl.bind(this),this._onPointerDown=Pl.bind(this),this._onPointerUp=Il.bind(this),this._onContextMenu=Ul.bind(this),this._onMouseWheel=zl.bind(this),this._onKeyDown=Bl.bind(this),this._onTouchStart=Vl.bind(this),this._onTouchMove=Hl.bind(this),this._onMouseDown=Ll.bind(this),this._onMouseMove=Rl.bind(this),this._interceptControlDown=Wl.bind(this),this._interceptControlUp=Gl.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(wl),this.update(),this.state=$.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Al.copy(t).sub(this.target),Al.applyQuaternion(this._quat),this._spherical.setFromVector3(Al),this.autoRotate&&this.state===$.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=jl:n>Math.PI&&(n-=jl),r<-Math.PI?r+=jl:r>Math.PI&&(r-=jl),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Al.setFromSpherical(this._spherical),Al.applyQuaternion(this._quatInverse),t.copy(this.target).add(Al),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Al.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new K(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new K(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Al.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Dl.origin.copy(this.object.position),Dl.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Dl.direction))<kl?this.object.lookAt(this.target):(Ol.setFromNormalAndCoplanarPoint(this.object.up,this.target),Dl.intersectPlane(Ol,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Ml||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Ml||this._lastTargetPosition.distanceToSquared(this.target)>Ml?(this.dispatchEvent(wl),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?jl/60/60*this.autoRotateSpeed:jl/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Al.setFromMatrixColumn(t,0),Al.multiplyScalar(-e),this._panOffset.add(Al)}_panUp(e,t){this.screenSpacePanning===!0?Al.setFromMatrixColumn(t,1):(Al.setFromMatrixColumn(t,0),Al.crossVectors(this.object.up,Al)),Al.multiplyScalar(e),this._panOffset.add(Al)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Al.copy(r).sub(this.target);let i=Al.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(jl*this._rotateDelta.x/t.clientHeight),this._rotateUp(jl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-jl*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(jl*this._rotateDelta.x/t.clientHeight),this._rotateUp(jl*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new G,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Pl(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Fl(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Il(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(El),this.state=$.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function Ll(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=$.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=$.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=$.PAN}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Tl)}function Rl(e){switch(this.state){case $.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case $.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case $.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function zl(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===$.NONE&&(e.preventDefault(),this.dispatchEvent(Tl),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(El))}function Bl(e){this.enabled!==!1&&this._handleKeyDown(e)}function Vl(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=$.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=$.TOUCH_PAN;break;default:this.state=$.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=$.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=$.TOUCH_DOLLY_ROTATE;break;default:this.state=$.NONE}break;default:this.state=$.NONE}this.state!==$.NONE&&this.dispatchEvent(Tl)}function Hl(e){switch(this._trackPointer(e),this.state){case $.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case $.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case $.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case $.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=$.NONE}}function Ul(e){this.enabled!==!1&&e.preventDefault()}function Wl(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function Gl(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var Kl=class{constructor(e,t){this.controls=new Nl(e,t),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.minDistance=50,this.controls.maxDistance=1200,this.controls.enablePan=!0,this.controls.autoRotate=!0,this.controls.autoRotateSpeed=.15,this.presets={overview:{pos:new K(0,250,600),target:new K(0,0,0)},center:{pos:new K(20,30,80),target:new K(0,0,0)},spiral:{pos:new K(200,80,250),target:new K(100,0,100)},outer:{pos:new K(0,150,500),target:new K(0,0,0)},top:{pos:new K(0,500,.1),target:new K(0,0,0)},side:{pos:new K(500,0,.1),target:new K(0,0,0)}}}update(){this.controls.update()}goToPreset(e){let t=this.presets[e];if(!t)return;let n=this.controls.object.position.clone(),r=this.controls.target.clone(),i=t.pos.clone(),a=t.target.clone(),o=performance.now(),s=e=>{let t=e-o,c=Math.min(t/1500,1),l=c<.5?4*c*c*c:1-(-2*c+2)**3/2;this.controls.object.position.lerpVectors(n,i,l),this.controls.target.lerpVectors(r,a,l),this.controls.update(),c<1&&requestAnimationFrame(s)};requestAnimationFrame(s)}reset(){this.goToPreset(`overview`)}},ql=class{constructor(e){this.onChange=e,this.isVisible=!0,this.panel=this.createUI(),document.body.appendChild(this.panel)}createUI(){let e=document.createElement(`div`);return e.className=`control-panel`,e.innerHTML=`
    ...
    `,this.attachListeners(e),e}attachListeners(e){let t=(t,n,r)=>{let i=e.querySelector(t);i&&i.addEventListener(n,r)};t(`#rotation-speed`,`input`,e=>this.onChange(`rotationSpeed`,e.target.value/1e3)),t(`#brightness`,`input`,e=>this.onChange(`brightness`,e.target.value/100)),t(`#nebula-intensity`,`input`,e=>this.onChange(`nebulaIntensity`,e.target.value/100)),t(`#dust-density`,`input`,e=>this.onChange(`dustDensity`,e.target.value/100)),t(`#bloom`,`input`,e=>this.onChange(`bloom`,e.target.value/100)),t(`#quality`,`change`,e=>this.onChange(`quality`,e.target.value)),t(`[data-preset]`,`click`,e=>this.onChange(`preset`,e.target.dataset.preset)),t(`#reset-camera`,`click`,()=>this.onChange(`preset`,`overview`)),t(`#pause-btn`,`click`,()=>this.onChange(`pause`)),t(`#info-btn`,`click`,()=>{let t=e.querySelector(`#info-panel`);t.style.display=t.style.display===`none`?`block`:`none`})}updateStats(e,t){let n=document.getElementById(`fps-counter`),r=document.getElementById(`star-counter`);n&&(n.textContent=`${Math.round(e)} FPS`),r&&(r.textContent=`${t.toLocaleString()} Stars`)}toggle(){this.isVisible=!this.isVisible,this.panel.style.display=this.isVisible?`block`:`none`}};function Jl(e){let t=e;return function(){return t=(t*16807+0)%2147483647,(t-1)/2147483646}}function Yl(e,t,n){return t+e()*(n-t)}function Xl(e){let t=0,n=0;for(;t===0;)t=e();for(;n===0;)n=e();return Math.sqrt(-2*Math.log(t))*Math.cos(2*Math.PI*n)}function Zl(e,t,n){return t+Xl(e)*n}function Ql(e){let t,n,r;return e<3500?(t=1,n=.3,r=.1):e<5e3?(t=1,n=.6,r=.3):e<6500?(t=1,n=.85,r=.7):e<1e4?(t=.85,n=.9,r=1):e<2e4?(t=.6,n=.75,r=1):(t=.4,n=.6,r=1),{r:t,g:n,b:r}}function $l(e){let t=[3e3,3500,4e3,5e3,6e3,6500,7500,1e4,15e3,25e3],n=[.05,.1,.15,.2,.15,.15,.1,.05,.03,.02],r=n.reduce((e,t)=>e+t,0),i=e()*r;for(let e=0;e<t.length;e++)if(i-=n[e],i<=0)return t[e];return 6500}var eu=`
...
`,nu=class{constructor(e){this.config=e,this.group=new Cn}createBackgroundStars(e,t){let n=new wr,r=new Float32Array(e*3),i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e),s=Jl(12345);for(let n=0;n<e;n++){let e=s()*Math.PI*2,c=Math.acos(2*s()-1),l=t*(.8+s()*.4);r[n*3]=l*Math.sin(c)*Math.cos(e),r[n*3+1]=l*Math.sin(c)*Math.sin(e),r[n*3+2]=l*Math.cos(c);let u=Ql($l(s));i[n*3]=u.r,i[n*3+1]=u.g,i[n*3+2]=u.b,a[n]=Yl(s,.5,2),o[n]=Yl(s,.3,1)}n.setAttribute(`position`,new X(r,3)),n.setAttribute(`customColor`,new X(i,3)),n.setAttribute(`size`,new X(a,1)),n.setAttribute(`brightness`,new X(o,1));let c=new ki(n,new Ji({vertexShader:eu,fragmentShader:tu,transparent:!0,depthWrite:!1,blending:2}));return this.group.add(c),c}createGalaxyStars(e){let t=new wr,n=e.starCount,r=new Float32Array(n*3),i=new Float32Array(n*3),a=new Float32Array(n),o=new Float32Array(n),s=Jl(42),{galaxyRadius:c,coreRadius:l,barLength:u,spiralArms:d,armSpread:f,diskThickness:p}=e,m=Math.floor(n*.15),h=Math.floor(n*.1),g=Math.floor(n*.55),_=Math.floor(n*.15),v=n-m-h-g-_,y=0;for(let e=0;e<m;e++){let e=Zl(s,0,l*.4),t=s()*Math.PI*2,n=Math.acos(2*s()-1),c=Math.abs(e);r[y*3]=c*Math.sin(n)*Math.cos(t),r[y*3+1]=c*Math.sin(n)*Math.sin(t)*.6,r[y*3+2]=c*Math.cos(n);let u=Ql(Yl(s,4e3,1e4));i[y*3]=u.r,i[y*3+1]=u.g,i[y*3+2]=u.b,a[y]=Yl(s,1,3.5),o[y]=Yl(s,.8,1.2),y++}for(let e=0;e<h;e++){let e=Yl(s,-1,1),t=Math.abs(e)*u,n=Zl(s,0,u*.2),c=Zl(s,0,p*.5);r[y*3]=t*Math.sign(e),r[y*3+1]=c,r[y*3+2]=n;let l=Ql(Yl(s,4500,9e3));i[y*3]=l.r,i[y*3+1]=l.g,i[y*3+2]=l.b,a[y]=Yl(s,1,3),o[y]=Yl(s,.7,1.1),y++}for(let e=0;e<g;e++){let e=Math.floor(s()*d)/d*Math.PI*2,t=s()**.6*c,n=e+t*.008+Zl(s,0,f*t*.3),l=Zl(s,0,t*.15),u=t*Math.cos(n)+l*Math.cos(n+Math.PI/2),m=t*Math.sin(n)+l*Math.sin(n+Math.PI/2),h=Zl(s,0,p*(.3+t/c*.7));r[y*3]=u,r[y*3+1]=h,r[y*3+2]=m;let g=t/c,_;_=g<.3?Yl(s,5e3,12e3):g<.7?Yl(s,6e3,2e4):Yl(s,3e3,8e3);let v=Ql(_);i[y*3]=v.r,i[y*3+1]=v.g,i[y*3+2]=v.b,a[y]=Yl(s,.8,2.5),o[y]=Yl(s,.6,1),y++}for(let e=0;e<_;e++){let e=s()**.5*c,t=s()*Math.PI*2,n=e*Math.cos(t),l=e*Math.sin(t),u=Zl(s,0,p*.3);r[y*3]=n,r[y*3+1]=u,r[y*3+2]=l;let d=Ql(Yl(s,3e3,7e3));i[y*3]=d.r,i[y*3+1]=d.g,i[y*3+2]=d.b,a[y]=Yl(s,.5,1.5),o[y]=Yl(s,.4,.8),y++}for(let e=0;e<v;e++){let e=s()*Math.PI*2,t=Math.acos(2*s()-1),n=c*(1.2+s()*.8);r[y*3]=n*Math.sin(t)*Math.cos(e),r[y*3+1]=n*Math.sin(t)*Math.sin(e)*.4,r[y*3+2]=n*Math.cos(t);let l=Ql(Yl(s,3e3,6e3));i[y*3]=l.r,i[y*3+1]=l.g,i[y*3+2]=l.b,a[y]=Yl(s,.3,1.2),o[y]=Yl(s,.2,.6),y++}t.setAttribute(`position`,new X(r,3)),t.setAttribute(`customColor`,new X(i,3)),t.setAttribute(`size`,new X(a,1)),t.setAttribute(`brightness`,new X(o,1));let b=new ki(t,new Ji({vertexShader:eu,fragmentShader:tu,transparent:!0,depthWrite:!1,blending:2}));return this.group.add(b),b}getGroup(){return this.group}},ru=class{constructor(e){this.config=e,this.group=new Cn}createCore(){let{coreRadius:e,barLength:t}=this.config,n=Jl(999),r=new wr,i=8e4,a=new Float32Array(i*3),o=new Float32Array(i*3),s=new Float32Array(i),c=new Float32Array(i);for(let t=0;t<i;t++){let r=Math.abs(Zl(n,0,e*.35)),i=n()*Math.PI*2,l=Math.acos(2*n()-1);a[t*3]=r*Math.sin(l)*Math.cos(i),a[t*3+1]=r*Math.sin(l)*Math.sin(i)*.5,a[t*3+2]=r*Math.cos(l);let u=1-r/e;o[t*3]=1,o[t*3+1]=.7+u*.25,o[t*3+2]=.4+u*.3,s[t]=Yl(n,1.5,4),c[t]=Yl(n,.9,1.3)}r.setAttribute(`position`,new X(a,3)),r.setAttribute(`customColor`,new X(o,3)),r.setAttribute(`size`,new X(s,1)),r.setAttribute(`brightness`,new X(c,1));let l=new ki(r,new Ji({vertexShader:`
        attribute float size;
        attribute vec3 customColor;
        attribute float brightness;
        varying vec3 vColor;
      ...
      `,transparent:!0,depthWrite:!1,blending:2}));this.group.add(l);let u=new fi(new zi(e*.6,32,32),new ei({color:new Y(1,.8,.5),transparent:!0,opacity:.08,side:1}));this.group.add(u);let d=new fi(new zi(e*.35,32,32),new ei({color:new Y(1,.9,.7),transparent:!0,opacity:.15,side:1}));return this.group.add(d),l}createBar(){let{barLength:e,coreRadius:t}=this.config,n=Jl(888),r=new wr,i=4e4,a=new Float32Array(i*3),o=new Float32Array(i*3),s=new Float32Array(i),c=new Float32Array(i);for(let r=0;r<i;r++){let i=Yl(n,-1,1),l=Math.abs(i)*e,u=Zl(n,0,e*.2),d=Zl(n,0,t*.4);a[r*3]=l*Math.sign(i),a[r*3+1]=d,a[r*3+2]=u,o[r*3]=1,o[r*3+1]=.75,o[r*3+2]=.5,s[r]=Yl(n,1,3),c[r]=Yl(n,.7,1.1)}r.setAttribute(`position`,new X(a,3)),r.setAttribute(`customColor`,new X(o,3)),r.setAttribute(`size`,new X(s,1)),r.setAttribute(`brightness`,new X(c,1));let l=new ki(r,new Ji({vertexShader:`
        attribute float size;
        attribute vec3 customColor;
        attribute float brightness;
        varying vec3 vColor;
      ...
      `,transparent:!0,depthWrite:!1,blending:2}));return this.group.add(l),l}createBlackHole(){let e=new Cn,t=new fi(new Ri(3,8,64),new ei({color:new Y(1,.6,.2),transparent:!0,opacity:.3,side:2}));t.rotation.x=Math.PI/2,e.add(t);let n=new fi(new zi(2,32,32),new ei({color:new Y(0,0,0)}));e.add(n);let r=new fi(new zi(4,32,32),new ei({color:new Y(.8,.4,.1),transparent:!0,opacity:.1,side:1}));return e.add(r),this.group.add(e),e}},iu=class{constructor(e){this.config=e,this.group=new Cn}createArms(){let{galaxyRadius:e,spiralArms:t,armSpread:n,diskThickness:r,starCount:i}=this.config,a=Math.floor(i*.55/t),o=[],s=[],c=[],l=[];for(let n=0;n<t;n++){let i=n/t*Math.PI*2,u=Jl(n*1e3+777);for(let t=0;t<a;t++){let t=u()**.55*e,n=i+t*.009,a=au(u,0,t*.12),d=t*Math.cos(n)+a*Math.cos(n+Math.PI/2),f=t*Math.sin(n)+a*Math.sin(n+Math.PI/2),p=au(u,0,r*(.25+t/e*.75));o.push(d,p,f);let m=t/e,h;h=m<.3?ou(u,5e3,12e3):m<.7?ou(u,7e3,22e3):ou(u,4e3,1e4);let g=Ql(h);s.push(g.r,g.g,g.b),c.push(ou(u,.8,2.5)),l.push(ou(u,.6,1))}}let u=new wr;u.setAttribute(`position`,new fr(o,3)),u.setAttribute(`customColor`,new fr(s,3)),u.setAttribute(`size`,new fr(c,1)),u.setAttribute(`brightness`,new fr(l,1));let d=new ki(u,new Ji({vertexShader:`
        attribute float size;
        attribute vec3 customColor;
        attribute float brightness;
        varying vec3 vColor;
      ...
      `,transparent:!0,depthWrite:!1,blending:2}));return this.group.add(d),d}};function au(e,t,n){let r=0,i=0;for(;r===0;)r=e();for(;i===0;)i=e();return t+Math.sqrt(-2*Math.log(r))*Math.cos(2*Math.PI*i)*n}function ou(e,t,n){return t+e()*(n-t)}var su=class{constructor(e){this.config=e,this.group=new Cn,this.sprites=[]}createNebulae(){let{galaxyRadius:e,nebulaCount:t}=this.config,n=Jl(555),r=[new Y(.8,.2,.3),new Y(.6,.1,.5),new Y(.2,.3,.7),new Y(.1,.5,.7),new Y(.7,.3,.5),new Y(.3,.2,.6)];for(let i=0;i<t;i++){let t=Math.floor(n()*4)/4*Math.PI*2,i=30+n()**.7*(e*.7),a=t+i*.009,o=cu(n,0,i*.2),s=i*Math.cos(a)+o*Math.cos(a+Math.PI/2),c=i*Math.sin(a)+o*Math.sin(a+Math.PI/2),l=cu(n,0,15),u=r[Math.floor(n()*r.length)],d=15+n()*60,f=.08+n()*.25,p=new Wr(new Ar({map:this.createNebulaTexture(u,d),blending:2,depthWrite:!1,transparent:!0,opacity:f}));p.position.set(s,l,c),p.scale.set(d*2,d*2,1),this.group.add(p),this.sprites.push(p)}return this.sprites}createNebulaTexture(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`),i=r.createRadialGradient(128,128,0,128,128,128);return i.addColorStop(0,`rgba(${Math.floor(e.r*255)}, ${Math.floor(e.g*255)}, ${Math.floor(e.b*255)}, 0.8)`),i.addColorStop(.3,`rgba(${Math.floor(e.r*255)}, ${Math.floor(e.g*255)}, ${Math.floor(e.b*255)}, 0.4)`),i.addColorStop(.6,`rgba(${Math.floor(e.r*200)}, ${Math.floor(e.g*150)}, ${Math.floor(e.b*180)}, 0.15)`),i.addColorStop(1,`rgba(0, 0, 0, 0)`),r.fillStyle=i,r.fillRect(0,0,256,256),new Mi(n)}};function cu(e,t,n){let r=0,i=0;for(;r===0;)r=e();for(;i===0;)i=e();return t+Math.sqrt(-2*Math.log(r))*Math.cos(2*Math.PI*i)*n}var lu=class{constructor(e){this.config=e,this.group=new Cn}createDust(){let{galaxyRadius:e,dustDensity:t,barLength:n,coreRadius:r,spiralArms:i}=this.config,a=Math.floor(e*t*15),o=new Float32Array(a*3),s=new Float32Array(a),c=new Float32Array(a),l=Jl(333);for(let t=0;t<a;t++){let n=Math.floor(l()*i)/i*Math.PI*2,r=10+l()**.5*e*.8,a=n+r*.009,u=uu(l,0,r*.18),d=r*Math.cos(a)+u*Math.cos(a+Math.PI/2),f=r*Math.sin(a)+u*Math.sin(a+Math.PI/2),p=uu(l,0,10);o[t*3]=d,o[t*3+1]=p,o[t*3+2]=f,s[t]=du(l,.1,.6),c[t]=du(l,8,40)}let u=new wr;u.setAttribute(`position`,new X(o,3)),u.setAttribute(`alpha`,new X(s,1)),u.setAttribute(`size`,new X(c,1));let d=new ki(u,new Ji({vertexShader:`
        attribute float size;
      ...
      `,transparent:!0,depthWrite:!1,blending:1,uniforms:{uDensity:{value:1}}}));return this.group.add(d),this.points=d,d}};function uu(e,t,n){let r=0,i=0;for(;r===0;)r=e();for(;i===0;)i=e();return t+Math.sqrt(-2*Math.log(r))*Math.cos(2*Math.PI*i)*n}function du(e,t,n){return t+e()*(n-t)}var fu=class{constructor(e){this.config=e,this.group=new Cn}createHalo(){let{galaxyRadius:e,haloStarCount:t}=this.config,n=new wr,r=new Float32Array(t*3),i=new Float32Array(t*3),a=new Float32Array(t),o=new Float32Array(t),s=Jl(666);for(let n=0;n<t;n++){let t=s()*Math.PI*2,c=Math.acos(2*s()-1),l=e*(1.1+s()*.9);r[n*3]=l*Math.sin(c)*Math.cos(t),r[n*3+1]=l*Math.sin(c)*Math.sin(t)*.35,r[n*3+2]=l*Math.cos(c);let u=Ql(pu(s,3e3,7e3));i[n*3]=u.r*.7,i[n*3+1]=u.g*.7,i[n*3+2]=u.b*.7,a[n]=pu(s,.2,.8),o[n]=pu(s,.15,.45)}n.setAttribute(`position`,new X(r,3)),n.setAttribute(`customColor`,new X(i,3)),n.setAttribute(`size`,new X(a,1)),n.setAttribute(`brightness`,new X(o,1));let c=new ki(n,new Ji({vertexShader:`
        attribute float size;
        attribute vec3 customColor;
        attribute float brightness;
        varying vec3 vColor;
      ...
      `,transparent:!0,depthWrite:!1,blending:2}));return this.group.add(c),c}};function pu(e,t,n){return t+e()*(n-t)}var mu=class{constructor(e){this.config=e,this.group=new Cn,this.components={}}build(){this.components.core=new ru(this.config),this.group.add(this.components.core.group),this.components.bar=this.components.core.createBar(),this.components.spiralArms=new iu(this.config),this.group.add(this.components.spiralArms.group),this.components.nebula=new su(this.config),this.group.add(this.components.nebula.group),this.nebulaSprites=this.components.nebula.sprites,this.components.nebula.createNebulae(),this.components.dust=new lu(this.config),this.group.add(this.components.dust.group),this.dustPoints=this.components.dust.createDust(),this.components.halo=new fu(this.config),this.group.add(this.components.halo.group),this.components.halo.createHalo(),this.components.core.createCore(),this.components.core.createBlackHole(),this.components.bgStars=new nu(this.config);let e=this.components.bgStars.createBackgroundStars(6e4,1200),t=new nu(this.config).createGalaxyStars(this.config);return this.group.add(t),this.components.mainStars=t,this.bgPoints=e,this.group}getGroup(){return this.group}},hu={galaxyRadius:500,coreRadius:80,barLength:140,spiralArms:4,starCount:4e4,armSpread:.25,diskThickness:35,haloStarCount:15e3,rotationSpeed:.05,starSize:1,nebulaCount:15,dustDensity:.5,bloomStrength:1},gu,_u,vu,yu,bu=!1,xu=hu.rotationSpeed,Su=!1;function Cu(){console.log(`[MilkyWay] init started`);let e=document.getElementById(`app`);if(!e){Du(`Error: #app container not found`);return}try{console.log(`[MilkyWay] Creating SceneManager...`),gu=new Cl(e),console.log(`[MilkyWay] SceneManager created, canvas size:`,gu.renderer.domElement.width,`x`,gu.renderer.domElement.height),_u=new Kl(gu.camera,gu.renderer.domElement),vu=new ql(Ou),window.addEventListener(`resize`,Au),document.addEventListener(`keydown`,ju),console.log(`[MilkyWay] Starting animation loop...`),Iu(),console.log(`[MilkyWay] Scheduling galaxy build...`),setTimeout(()=>{console.log(`[MilkyWay] Building galaxy...`),wu().then(()=>{console.log(`[MilkyWay] Galaxy built, hiding loading...`),Eu()}).catch(e=>{console.error(`[MilkyWay] Build failed:`,e),Eu(),Du(`Galaxy build failed: `+e.message)})},300),setTimeout(()=>{Su||(console.warn(`[MilkyWay] Galaxy not ready after 10s, forcing loading hide`),Eu())},1e4)}catch(e){console.error(`[MilkyWay] Init error:`,e),Du(`Init failed: `+e.message)}}async function wu(){try{console.log(`[MilkyWay] Galaxy build started`),await Tu(50),console.log(`[MilkyWay] Creating Galaxy instance...`),yu=new mu(hu),console.log(`[MilkyWay] Building galaxy group...`);let e=yu.build();console.log(`[MilkyWay] Adding galaxy to scene...`),gu.scene.add(e),await Tu(30),yu.bgPoints&&(console.log(`[MilkyWay] Adding background stars...`),gu.scene.add(yu.bgPoints));let t=hu.starCount+6e4+hu.haloStarCount;vu.updateStats(60,t),Su=!0,console.log(`[MilkyWay] Galaxy build complete, isReady=true`)}catch(e){console.error(`[MilkyWay] Galaxy build error:`,e),Du(`Galaxy build failed: `+e.message)}}function Tu(e){return new Promise(t=>setTimeout(t,e))}function Eu(){console.log(`[MilkyWay] hideLoading called`);let e=document.getElementById(`loading`);e&&(e.classList.add(`hidden`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},800))}function Du(e){console.error(`[MilkyWay]`,e);let t=document.createElement(`div`);t.style.cssText=`position:fixed;top:20px;left:20px;right:20px;background:rgba(255,0,0,0.2);color:#ff9999;padding:15px;border-radius:8px;font-family:monospace;z-index:9999;max-width:600px;`,t.textContent=`Error: `+e,document.body.appendChild(t)}function Ou(e,t){switch(e){case`preset`:_u.goToPreset(t);break;case`pause`:bu=!bu;break;case`rotationSpeed`:xu=t;break;case`brightness`:break;case`nebulaIntensity`:yu&&yu.nebulaSprites&&yu.nebulaSprites.forEach(e=>{e.material&&(e.material.opacity=t*.4)});break;case`dustDensity`:yu&&yu.dustPoints&&yu.dustPoints.material.uniforms&&(yu.dustPoints.material.uniforms.uDensity.value=t);break;case`bloom`:gu.bloomPass&&(gu.bloomPass.strength=t*.02);break;case`quality`:ku(t)}}function ku(e){let t={low:4e4,medium:8e4,high:15e4,ultra:25e4}[e]||8e4;if(t!==hu.starCount){if(hu.starCount=t,yu){let e=yu.getGroup(),t=yu.bgPoints;gu.scene.remove(e),t&&gu.scene.remove(t),e.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(e.material.map&&e.material.map.dispose(),e.material.dispose())})}wu()}}function Au(){gu.resize()}function ju(e){switch(e.key.toLowerCase()){case`r`:_u.reset();break;case`p`:bu=!bu;break;case`g`:_u.goToPreset(`overview`);break;case`c`:_u.goToPreset(`center`);break;case`i`:let e=document.getElementById(`info-panel`);e&&(e.style.display=e.style.display===`none`?`block`:`none`);break;case`u`:vu.toggle()}}var Mu=performance.now(),Nu=0,Pu=60,Fu=!1;function Iu(){requestAnimationFrame(Iu),Nu++;let e=performance.now();if(e-Mu>=1e3){Pu=Nu,Nu=0,Mu=e;let t=hu.starCount+6e4+hu.haloStarCount;vu.updateStats(Pu,t)}if(!bu&&Su&&yu){let e=gu.getDelta();yu.getGroup().rotation.y+=xu*e,Fu||(Fu=!0,console.log(`[MilkyWay] First galaxy frame rendered`),setTimeout(Eu,100))}_u.update(),gu.render()}Cu();